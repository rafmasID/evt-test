...
<xsl:stylesheet xpath-default-namespace="http://www.tei-c.org/ns/1.0"
	...
	<xsl:template match="tei:body/node()" mode="splitZero">
		<xsl:choose>
			<xsl:when test="lb|pb">
	...
	<!-- EN: Close and open back elements when you find a pb or an lb -->
	<!-- IT: Chiudi e riapri i tag quando trovi un pb o un lb -->
	<xsl:template match="tei:body/node()/node()" mode="split-1">
		<xsl:choose>
			<xsl:when test="lb|pb">
				<xsl:for-each-group select="node()" group-starting-with="lb|pb">
					<!-- IT: copia lb/pb se presente nel gruppo -->
	...
	<!-- EN: Close and open back elements when you find a pb or an lb -->
	<!-- IT: Chiudi e riapri i tag quando trovi un pb o un lb -->
	<xsl:template match="tei:body/node()/node()/node()" mode="split-2">
		<xsl:choose>
			<xsl:when test="lb|pb">
				<xsl:for-each-group select="node()" group-starting-with="lb|pb">
					<!-- IT: copia lb/pb se presente nel gruppo -->
	...
	<!-- IT: Chiudi e riapri i tag quando trovi un pb o un lb -->
	<xsl:template match="tei:body/node()/node()/node()/node()" mode="split-3">
		<xsl:choose>
			<xsl:when test="lb|pb">
				<xsl:for-each-group select="node()" group-starting-with="lb|pb">
					<!-- EN: copy lb/pb if present in this group -->
	...
	<!-- IT: Chiudi e riapri i tag quando trovi un pb o un lb -->
	<xsl:template match="tei:body/node()/node()/node()/node()/node()" mode="split-4">
		<xsl:choose>
			<xsl:when test="lb|pb">
				<xsl:for-each-group select="node()" group-starting-with="lb|pb">
					<!-- EN: copy lb/pb if present in this group -->
	...
	<!-- IT: Chiudi e riapri i tag quando trovi un pb o un lb -->
	<xsl:template match="tei:body/node()/node()/node()/node()/node()/node()" mode="split-5">
		<xsl:choose>
			<xsl:when test="lb|pb">
				<xsl:for-each-group select="node()" group-starting-with="lb|pb">
					<!-- EN: copy lb/pb if present in this group -->
	...
	<!-- EN: Copy all -->
	<!-- IT: Copia tutto -->
	<xsl:template match="@*|node()" mode="split-5 split-4 split-3 split-2 split-1 splitZero">
